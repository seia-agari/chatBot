...
const QA = [
  // 【理念・目標編】
  {
    ...
    a: `【回答】
スマイルスタディの理念は「子どもたちの夢や目標を叶える応援がしたい」という想いを、講師全員で共有することです。入塾前の成績に関わらず、一人ひとりの可能性を最後まで信じ、成長に寄り添います。<br>👉 詳細は <a href="https://www.notion.so/1-1-24ab49866bd48182b2bac600ec46ae84?source=copy_link" target="_blank" rel="noopener">1対1スマイルスタディの理念</a> をご覧ください。
<br><img src="https://smilestudy-kasukabe.com/wp-content/uploads/2021/05/AdobeStock_394942887.jpeg" alt="SC" style="max-width:250px; border-radius:8px;">`
  },
  {
    q: "教室全体の目標は？",
...
・Study Community：学び合う空間の創出<br>👉 詳細は <a href="https://www.notion.so/4-SC-24ab49866bd48042822df99121c59322?source=copy_link" target="_blank" rel="noopener">４つのSC</a> をご覧ください。`
  },
  {
    q: "SC実践のポイント",
...
},
{
  ...
  a: `【回答】
病欠の場合は、振替をお願いいたします。振替日時を相談し、決定後カレンダーの振替ボタンで変更してください。`
},
{
...
7. 公開したい場合は上利へ報告（講師は直接公開できません）`
  ...
  // 【面談編】
  {
    ...
    a: `【回答】
面談の目的は、生徒の学習状況・成績・今後の方針を保護者と共有し、最適な学習環境を提案することです。期待値のすり合わせを丁寧に行います。<br>👉 詳細は <a href="https://www.notion.so/227b49866bd480018465dca6562fc1fb?source=copy_link" target="_blank" rel="noopener">面談マニュアル</a> をご覧ください。`
  },
  {
    q: "面談準備でやること",
...
2. 面談資料作成
    ...
    - 記載内容：成績分析・課題と改善案・今後の方針・注意点<br>👉 詳細は <a href="https://www.notion.so/2025-227b49866bd48152852ee7bb77d7981d?source=copy_link" target="_blank" rel="noopener">2025年面談資料作成</a> をご覧ください。
3. 面談実施（30〜40分）
    - 早めの準備、明るく丁寧な挨拶
    - 約束事はメモ、成績資料をしっかり把握
...
3) 使用教材と進捗
4) 授業の進め方・ルーティン
5) 注意点や特記事項（配慮事項を含む）<br>👉 詳細は <a href="https://www.notion.so/227b49866bd480039a6ff95f233bc378?source=copy_link" target="_blank" rel="noopener">引継ぎ資料マニュアル</a> をご覧ください。`
  },
  {
    q: "引継ぎ資料の期限",
    kws: ["引継ぎ","資料","期限"],
...
提出期限は担当が変わる月の末日16:00までです。報酬は生徒管理業務に含まれ、期限厳守です。提出が遅れると新担当の授業に支障をきたすため必ず守ってください。`
  ...
  // 【給与報告編】
  {
    ...
    kws: ["給与","給与報告","いつ","方法"],
    a: `【回答】
毎月30日に、Notionトップページにある「給与報告フォーム」から報告してください。<br>👉 わからない方はこちらの<a href="https://even-verse-2c8.notion.site/23eb49866bd4804e98b2e03e29ab300e?pvs=143" target="_blank" rel="noopener">給与報告フォーム</a> からも同じようにご回答いただけます。`
  },
...
3. 最後の面談
    - この塾でどう成長できるか未来像を提案
    - 例：「英語文法を整理しながら長文読解に自信を」「数学は基礎から復習して関数につなげる」<br>👉 詳細は <a href="https://www.notion.so/229b49866bd4807e8587e2ea9d3da268?source=copy_link" target="_blank" rel="noopener">体験授業マニュアル</a> をご覧ください。`
  },
...
2. 領収書の発行：受付にある写真付き用紙からA.領収書を切り離し
、生徒に渡します。日付・生徒名を記入し、領収印に塾長のシャチハタ印を押してください。
3. 現金の処理：現金はコピー機横の「あいか」のトレーに入れます。<br>
<img src="https://smilestudy-kasukabe.com/wp-content/uploads/2025/08/S__148004868.jpg" alt="あいか" style="max-width:200px; border-radius:8px;"><br>
...
{
  q: "成績管理業務について",
  kws: ["成績", "テスト結果", "個票", "成績回収", "成績管理", "成績報告", "成績共有"],
  a: `【回答】
担当科目に限らず、生徒の全科目のテスト結果を確認・回収してください。
成績の共有は写真などの形式でも問題ありません。
回収した成績は必ず上利までご報告ください。
可能であれば、生徒の個票（成績詳細票）を印刷して各生徒ファイルに保存してください。
これらは面談や今後の学習方針を検討する際に大変有効な資料となります。`
},
...
},
{
  ...
  kws: ["長期休み", "休暇", "長期欠勤", "申請", "休職", "休業", "長期不在", "留学"],
  a: `【回答】
...
},
{
  ...
  a: `【回答】
本日の授業を振替したい旨を生徒にお知らせする必要がありますので、必ず午前中までに上利先生と塾長にご連絡ください。`
},
...
不安や疑問がある場合は、一人で抱え込まず、必ず上利または塾長へ相談してください。早期共有が最善策につながります。`
   ...
   // 【コピー関連】
{
  q: "B5でコピーできません。どのようにすればいいですか？",
  kws: ["コピー", "B5", "印刷", "できない"],
  a: `【回答】 コピー機の機能上、A4・B4・A3しか対応していません。そのいずれかのサイズで印刷してください。`
},
{
  q: "コピー機が動かなくなりました。どうすればいいでしょうか？",
  kws: ["コピー機", "動かない", "電源", "故障"],
  a: `【回答】 一度電源を切ってください。全面の蓋を開け、主電源スイッチを下に下ろし、もう一度上に上げてください。これで改善しない場合は、塾長または上利先生にご連絡ください。`
},

// 【指導関連】
{
  q: "中学生の英語の指導法がわかりません。どのように教えたらいいですか？",
  kws: ["中学生", "英語", "指導法", "教え方"],
  a: `【回答】 
1. 基礎の徹底反復  
- 文法：『例文でしっかり身につく中学英文法108』で暗記＋小テストを継続  
- 単語：『ターゲット中学英単語1800』を使い、ノート・音読・書き取りで覚える  

2. 授業の進め方  
- 演習は必ず時間を設定してペース感覚を養う  
- 授業中も口頭確認や再テストで定着を「見える化」  

3. 声かけの工夫  
- 結果より努力を褒める（例：「覚えたね！」「前より早くできたね！」）  
- 適度に雑談を挟み、安心感を与える  

4. 期待される変化  
- 基礎の定着 → 成功体験 → 勉強習慣の定着  
- 授業姿勢が前向きになり、保護者からも「勉強時間が増えた」と評価される `
},
{
  q: "生徒のやる気がありません。どのようにすればいいですか？",
  kws: ["生徒", "やる気", "モチベーション", "勉強しない"],
  a: `【回答】 小さな成功体験を積ませることが効果的です。簡単な問題から取り組ませ、できたことを具体的に褒めることで徐々にやる気を引き出してください。<br>
  <img src="https://smilestudy-kasukabe.com/wp-content/uploads/2021/11/S__9363467.jpg" alt="生徒と講師" style="max-width:250px; border-radius:8px;">
`
},
{
  q: "小学生の接し方が難しいです。どのようにしたらいいですか？",
  kws: ["小学生", "接し方", "教え方"],
  a: `【回答】 
  1.	説明は短く端的に
	•	小学生は長い説明に飽きやすいため、必要以上に引き延ばさない。
	•	1つの説明は「短く・分かりやすく・具体的に」を徹底する。
	2.	活動は20分単位で区切る
	•	約20分ごとに活動を切り替えることで、集中力をリセットできる。
	•	「説明 → 演習 → 発表」など、リズムをつけて進める。
	3.	授業全体の流れ（80分授業の場合）
	•	20分 × 4セットを意識し、各区切りごとに小さな達成感を持たせる。
	•	区切りがあることで、結果的に最後まで前向きに取り組みやすくなる。
	4.	「褒める」ことを重視
	•	小さな成功でも必ず褒める。
	•	「できた」「認められた」という経験がモチベーションの継続につながる。
	•	行動（頑張ったこと）と結果（解けたこと）の両方を褒めるのが効果的。 `
},
{
  q: "志望校が決まらず、目標がない生徒がいます。どのようにしたらいいですか？",
  kws: ["志望校", "目標", "生徒", "決まらない"],
  a: `【回答】 将来の興味や得意科目の話をしながら、一緒に進路の選択肢を広げることが大切です。オープンキャンパスや学校紹介を勧め、イメージを具体化させてください。`
},
{
...
},
{
  q: "掛け持ちは可能ですか？",
  kws: ["掛け持ち", "他の仕事", "兼業"],
  a: `【回答】 掛け持ちは可能ですが？スケジュールに支障がない範囲でお願いします。`
},
{
  q: "担当生徒の変更を希望したい場合どのようにすればいいですか？",
  kws: ["担当変更", "生徒変更", "希望", "担当生徒"],
  a: `【回答】 担当生徒の変更を希望する場合は、必ず上利先生にご相談ください。`
},
...
// 【身だしなみ関連】
{
  q: "髪は染めてもいいでしょうか？",
  kws: ["髪", "染める", "カラー", "身だしなみ"],
  a: `【回答】 講師は清潔感が第一です。明るすぎる髪色は避け、自然な範囲であれば問題ありません。`
},
{
  q: "ネイル、化粧、ピアスなどはつけてもいいでしょうか？",
  kws: ["ネイル", "化粧", "ピアス", "身だしなみ"],
  a: `【回答】 化粧やピアスは派手すぎない範囲で可能です。ネイルは授業に支障が出ないシンプルなものにしてください。`
},
{
  q: "帽子はつけて授業は行ってもいいでしょうか？",
  kws: ["帽子", "授業", "身だしなみ"],
  a: `【回答】 帽子をかぶっての授業は原則禁止です。清潔感と誠実さを意識した服装で授業を行ってください。`
},
];
